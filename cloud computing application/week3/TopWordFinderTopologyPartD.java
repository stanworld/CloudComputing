...
public class TopWordFinderTopologyPartD {
  ...
  public static void main(String[] args) throws Exception {
    ...
    builder.setBolt("normalize",new NormalizerBolt(),2).shuffleGrouping("split");
    builder.setBolt("count", new WordCountBolt(), 3).shuffleGrouping("normalize");
    builder.setBolt("top-n", new TopNFinderBolt(N),3).shuffleGrouping("count");
